...
def repeater_mc(parameters, multiprocessing=False, return_pmf=False):
    ...
    w0 = parameters["w0"]
    lambdaA1 = parameters["lambdaA1"]
    lambdaB1 = parameters["lambdaB1"]
    lambdaA2 = parameters["lambdaA2"]
    lambdaB2 = parameters["lambdaB2"]
    lambdaA3 = parameters["lambdaA3"]
    lambdaB3 = parameters["lambdaB3"]
    lambdaA4 = parameters["lambdaA4"]
    lambdaB4 = parameters["lambdaB4"]
...
def mc_sample(network_parameters, sample_size, multiprocessing=True):
    ...
    t_samples_list = np.empty(sample_size, dtype=int64)
